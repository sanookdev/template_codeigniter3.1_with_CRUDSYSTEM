                                            ...
                                            <form class="uploadForm" action="<?= base_url('setting/upl_img') ?>"
                                                ...
                                                <div><a href="#" class="pop_banner">
                                                        <img id="imageresource1"
                                                            src="<?= base_url('uploads/banner/') . $options->banner_img1 . '?t='.time() ; ?>"
                                            ...
                                            <form class="uploadForm" action="<?= base_url('setting/upl_img') ?>"
                                                ...
                                                <div class=""><a href="#" class="pop_banner">
                                                        <img id="imageresource2"
                                                            src="<?= base_url('uploads/banner/') . $options->banner_img2. '?t='.time() ; ?>"
                                                            style="width: 300px; height: 264px; border: 3px solid #17a2b8;
                                                        padding: 15px;">
                                                    </a>
                                                </div>
                                            ...
                                            <form class="uploadForm" action="<?= base_url('setting/upl_img') ?>"
                                                ...
                                                <div class=""><a href="#" class="pop_banner">
                                                        <img id="background_img_login"
                                                            src="<?= base_url('uploads/banner/') . $options->background_img_login. '?t='.time() ; ?>"
                                                            style="width: 300px; height: 264px; border: 3px solid #17a2b8;
                                                        padding: 15px;">
                                                    </a>
                                                </div>
            ...
            function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            console.log(response);
                            let id_input_img = response.namefile;
                            let d = new Date();
                            id_input_img = id_input_img.split('.')[0];
                            let id_img = '';
                            if (id_input_img == 'banner_img1') {
                                id_img = 'imageresource1';
                            } else if (id_input_img == 'banner_img2') {
                                id_img = 'imageresource2'
                            } else {
                                id_img = 'background_img_login'
                            }
                            let src = $(`#${id_img}`).attr('src');
                            $(`#${id_img}`).attr('src', `${src}?t=${d.getTime()}`);
