        ...
        <nav>
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="#" id="course_title" class="nav-link">
                                ...
                                <p>Diploma-in-Clinical-Sexology</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" id="course_title" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview" style="display: none;">
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="<?= site_url('video/title')?>" class="nav-link">
                                        <i class="nav-icon far fa-dot-circle text-light"></i>
                                        <p>List</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        <i class="nav-icon far fa-dot-circle text-success"></i>
                                        <p>Add</p>
                                    </a>
                                </li>
                            </ul>
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="#" id="videos_title" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Title</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#" id="videos_details" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Videos</p>
                        </a>
                    </li>
